...
parser.add_argument('--summary_every', default=5, type=int) # batches per summary
...
def main(args):
    ...
    with graph.as_default():
        ...
        with tf.variable_scope(HEAD_SCOPE):
            net = tf.layers.conv2d(images,64,(3,3),(1,1),padding='SAME')
        ...
        with tf.Session(graph=graph) as sess:
            ...
            #     '/Users/kyle/Documents/SCHOOL/Stanford/STANFORD_2016_to_2017/3rd_Quarter/CS231N/Project/logs/MegaNet-2259.meta')
            head_saver.restore(
                sess,
                '/Users/kyle/Documents/SCHOOL/Stanford/STANFORD_2016_to_2017/3rd_Quarter/CS231N/Project/logs/MegaNet-2259')
            ...
            for epoch in range(args.num_epochs1):
                ...
                while True:
                    try:
                        kpt_loss, _ = sess.run([keypoint_loss, keypoint_mask_predictions], {is_training: False})
                        print('----- Losses for batch {}: Keypoint Loss: {:0>5}'.format(batch, kpt_loss))
